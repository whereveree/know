...
import io.wherevere.expandpopview.callback.IPopListView;
...
public class PopTwoListView extends PopLinearLayout implements IPopListView {
    ...
    private void init(Context context) {
        ...
        mParentAdapter.setSelectorBackground(Color.WHITE, getResources().getColor(R.color.color_selected_parent));
